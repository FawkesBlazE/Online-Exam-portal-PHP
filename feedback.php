...
{echo' 
You can send me your feedback through e-mail on the following e-mail id:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:karar.akash@gmail.com" style="color:#000000">karar.akash@gmail.com</a><br /><br />
...
<a href="https://github.com/FawkesBlazE/Online-Exam-portal-PHP" target="_blank">About</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/dev.jpg" width=100 height=100 alt="Akash Karar" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://github.com/FawkesBlazE" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Github">Akash karar</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+49 17675892814</h4>
		<h4 style="font-family:'typo' ">karar.akash@gmail.com</h4>
		<h4 style="font-family:'typo' ">SRH Hochchule Berlin</h4></div></div>
		</p>
      </div>
